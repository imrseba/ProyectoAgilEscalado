...
def crear_avance_grupo():
    ...
    selected_grupo = st.selectbox("Seleccione un Grupo:", grupo_names, key="grupo_selectbox")
    ...
    if selected_grupo:
        ...
        selected_sprint = st.selectbox("Seleccione un Sprint:", sprint_list, key="sprint_selectbox")
